...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_and_past_question(self):
        ...
        create_choice(question, "text", 0)
        create_choice(question2, "text", 0)
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(response.context['latest_question_list'], [question])
    ...
    def test_two_past_questions(self):
        ...
        create_choice(question1, "text", 0)
        create_choice(question2, "text", 0)
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(response.context['latest_question_list'], [question2, question1],)

    def test_no_choice(self):
        question = create_question(question_text="No Choice", days=-5)
        response = self.client.get(reverse('polls:index'))
        self.assertContains(response, "No polls are available")
        self.assertQuerysetEqual(response.context['latest_question_list'], [])
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        ...
        create_choice(future_question, "text", 0)
    ...
    def test_past_question(self):
        ...
        create_choice(past_question, "text", 0)
    ...
    def test_with_choice(self):
        question = create_question(question_text="With Choice", days=-5)
        create_choice(question, "text", 0)
        url = reverse('polls:detail', args = (question.id,))
        response = self.client.get(url)
